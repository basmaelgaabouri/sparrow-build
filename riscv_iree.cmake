...
elseif(RISCV_CPU STREQUAL "rv32-baremetal")
  ...
  list(APPEND RISCV_COMPILER_FLAGS "-menable-experimental-extensions -march=rv32imfv0p10 -mabi=ilp32 -DIREE_PLATFORM_GENERIC=1 -DIREE_SYNCHRONIZATION_DISABLE_UNSAFE=1 -DIREE_FILE_IO_ENABLE=0 -DIREE_TIME_NOW_FN=\"\{ return 0; \}\"")
  set(RISCV_LINKER_FLAGS "-Xlinker --defsym=__itcm_length__=256000 -lstdc++ -lm -T${SPRINGBOK_ROOT}/matcha.ld -nostartfiles ${SPRINGBOK_ROOT}/crt0.s")
endif()
