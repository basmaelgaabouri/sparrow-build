...
VC_TOP_GEN_DIR=$(KATA_OUT_DIR)/vc_top-gen/include/vc_top
$(VC_TOP_GEN_DIR):
	mkdir -p $(VC_TOP_GEN_DIR)

VC_TOP_HEADER=$(VC_TOP_GEN_DIR)/vc_top.h
$(VC_TOP_HEADER): $(REGTOOL) $(VC_TOP_HJSON) | $(VC_TOP_GEN_DIR)
	$(REGTOOL) -D -o $@ $(VC_TOP_HJSON)
